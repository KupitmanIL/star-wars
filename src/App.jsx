  ...
  return (
      <div className="container-fluid">
          ...
          <main className="clearfix">
              ...
              <section className="float-end w-50 row border border-warning rounded-bottom-3 mt-1 ms-2 me-0">
                  ...
                  <img className="rounded-bottom-left col-sm-4 p-1" src={friend7}
                       alt="Friend"/>
                  <img className="col-sm-4 p-1" src={friend8} alt="Friend"/>
                  <img className="rounded-bottom-right col-sm-4 p-1" src={friend9}
                       alt="Friend"/>
              </section>
